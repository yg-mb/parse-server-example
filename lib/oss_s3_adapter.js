...
function OSS_S3Adapter(s3Adapter, ossAdapter, readAdapter) {
...
OSS_S3Adapter.prototype.getFileData = function(filename) {
  return this.readAdapter.getFileData(filename);
}
...
OSS_S3Adapter.prototype.getFileLocation = function(config, filename) {
  return this.readAdapter.getFileLocation(config, filename);
}
